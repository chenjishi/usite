...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
        ...
        int tabWidth = getResources().getDisplayMetrics().widthPixels / 6;
    ...
    public void setTheme(int theme) {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            child.setTextColor(getResources().getColorStateList(isNight ?
                    R.color.tab_text_color_night : R.color.tab_text_color));
            child.setBackgroundResource(isNight ? R.drawable.tab_indicator_night
                    : R.drawable.abs__tab_indicator_ab_holo);
        }
    }
    ...
    private class TabView extends TextView {
        ...
        public TabView(Context context) {
            ...
            setTextSize(TypedValue.COMPLEX_UNIT_SP, 14.f);
            setGravity(Gravity.CENTER);
            setBackgroundResource(R.drawable.abs__tab_indicator_ab_holo);
        }
