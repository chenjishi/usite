...
public class Constants {
    ...
    public static final String API_ADD_FAVORITE = "xxxxx";
    public static final String API_DELETE_FAVORITE = "xxxxx";
    public static final String API_LOGIN = "xxxx";
    public static final String API_REGISTER = "xxxxx";
    public static final String API_COMMENTS_GET = BASE_URL + "get_comment/%1$s/%2$d";
    public static final String API_COMMENT_POST = "xxxx";
